...
public class Bill implements Serializable {
	...
	public Bill(int billId, int customerId, String customerName, float price, String description) {
		Service reserveService = new Service(ServiceType.RESERVATION, price, 1, description);
